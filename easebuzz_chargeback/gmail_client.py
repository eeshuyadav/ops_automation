...
class ApiClient:
    ...
    def send_reply(self, *, to: str, cc: str = "", subject: str, html_body: str,
        ...
        """Send a reply. Optional `attachments` = list of (filename, raw_bytes,
        mime_subtype). When supplied, the message is built as multipart/mixed
        with each attachment as its own MIMEApplication part."""
        if attachments:
